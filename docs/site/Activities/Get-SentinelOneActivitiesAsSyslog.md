...
online version: https://celerium.github.io/SentinelOne-PowerShellWrapper/site/Activities/Get-SentinelOneActivitiesAsSyslog.html
parent: GET
schema: 2.0.0
title: Get-SentinelOneActivitiesAsSyslog
---
...
### index (Default)
```powershell
Get-SentinelOneActivitiesAsSyslog [-accountIds <Int64[]>] [-activityTypes <Int64[]>] [-activityUuids <String[]>]
...
### indexByType
```powershell
Get-SentinelOneActivitiesAsSyslog [-typesOnly] [<CommonParameters>]
```
...
[https://celerium.github.io/SentinelOne-PowerShellWrapper/site/Activities/Get-SentinelOneActivitiesAsSyslog.html](https://celerium.github.io/SentinelOne-PowerShellWrapper/site/Activities/Get-SentinelOneActivitiesAsSyslog.html)
