...
#Available inside It but NOT Describe or Context
    ...
    AfterAll{
        ...
        Remove-SentinelOneBaseUri -WarningAction SilentlyContinue
...
Describe "Testing [ $commandName ] function with [ $pester_TestName ]" -Tag @('apiKeys') {
    ...
    Context "[ $commandName ] testing function" {
        ...
        It "[ Test-SentinelOneAPIKey ] with a bad API key should fail to authenticate" {
            Add-SentinelOneBaseUri
            Add-SentinelOneAPIKey -Api_Key '12345'

            $Value = Test-SentinelOneAPIKey 3>$null
