...
online version: https://celerium.github.io/SentinelOne-PowerShellWrapper/site/Activities/Get-SentinelOneActivities.html
parent: GET
schema: 2.0.0
title: Get-SentinelOneActivities
---
...
### index (Default)
```powershell
Get-SentinelOneActivities [-accountIds <Int64[]>] [-activityTypes <Int64[]>] [-activityUuids <String[]>]
...
### indexByType
```powershell
Get-SentinelOneActivities [-typesOnly] [<CommonParameters>]
```
...
[https://celerium.github.io/SentinelOne-PowerShellWrapper/site/Activities/Get-SentinelOneActivities.html](https://celerium.github.io/SentinelOne-PowerShellWrapper/site/Activities/Get-SentinelOneActivities.html)
