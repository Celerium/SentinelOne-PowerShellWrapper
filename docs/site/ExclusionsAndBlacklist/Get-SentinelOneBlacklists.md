...
online version: https://celerium.github.io/SentinelOne-PowerShellWrapper/site/ExclusionsAndBlacklist/Get-SentinelOneBlacklists.html
parent: GET
schema: 2.0.0
title: Get-SentinelOneBlacklists
---
...
```powershell
Get-SentinelOneBlacklists [-accountIds <String[]>] [-countOnly] [-createdAt__between <String>]
...
[https://celerium.github.io/SentinelOne-PowerShellWrapper/site/ExclusionsAndBlacklist/Get-SentinelOneBlacklists.html](https://celerium.github.io/SentinelOne-PowerShellWrapper/site/ExclusionsAndBlacklist/Get-SentinelOneBlacklists.html)
